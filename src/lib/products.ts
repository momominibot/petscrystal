...
export const products: Product[] = [
  ...
  },
  {
    id: "evil-eye-ward",
    name: "Evil Eye Ward",
    tagline: "Ancient protection, worn lightly",
    price: 89,
    crystal: "Evil Eye & Black Obsidian",
    chakra: "Root",
    petBenefit: "Traditional guardian symbol for the one who ventures out",
    humanBenefit: "Wards off negative energy & grounds the spirit",
    colors: ["#1A1A2E", "#0F3460", "#E94560", "#F5F5F5"],
    image: "/products/evil-eye-ward.jpg",
    stripePriceId: "",
    neckMin: 25,
    neckMax: 32,
    grams: 58,
  ...
  },
  {
    id: "fluorite-mist",
    name: "Fluorite Mist",
    tagline: "Quiet clarity for overstimulated souls",
    price: 89,
    crystal: "Rainbow Fluorite",
    chakra: "Third Eye",
    petBenefit: "Long chosen for scattered energy & overstimulation",
    humanBenefit: "Brings mental order & absorbs mental fog",
    colors: ["#7B68EE", "#48D1CC", "#98FB98", "#DDA0DD", "#F0E68C"],
    image: "/products/fluorite-mist.jpg",
    stripePriceId: "",
    neckMin: 23,
    neckMax: 30,
    grams: 55,
  ...
  },
  {
    id: "chakra-wheel",
    name: "Chakra Wheel",
    tagline: "Full-spectrum balance, seven stones aligned",
    price: 89,
    crystal: "Seven Chakra Stones",
    chakra: "All Seven",
    petBenefit: "A complete spectrum for the companion who needs it all",
    humanBenefit: "Aligns every energy centre from root to crown",
    colors: ["#C44536", "#E8967A", "#F5D34B", "#8FBF6A", "#7EC8E3", "#4A6FA5", "#9B8EC4"],
    image: "/products/chakra-wheel.jpg",
    stripePriceId: "",
    neckMin: 27,
    neckMax: 34,
    grams: 72,
  ...
  },
  {
    id: "pearl-dusk",
    name: "Pearl Dusk",
    tagline: "Soft light for quiet hearts",
    price: 89,
    crystal: "Freshwater Pearl & Amethyst",
    chakra: "Crown",
    petBenefit: "Lunar softness for the gentle companion who startles easily",
    humanBenefit: "Brings inner wisdom & emotional balance",
    colors: ["#F0E6FA", "#E8DFF0", "#D5CCE8", "#FFFAF0", "#9B8EC4"],
    image: "/products/pearl-dusk.jpg",
    stripePriceId: "",
    neckMin: 23,
    neckMax: 29,
    grams: 50,
  ...
  },
  {
    ...
    tagline: "Warm vitality for playful spirits",
    price: 89,
    crystal: "Carnelian",
    chakra: "Sacral",
    petBenefit: "Long carried for warmth & vitality — for the one who never tires",
    humanBenefit: "Ignites creativity, motivation & personal warmth",
    colors: ["#D2691E", "#E8967A", "#F5C842", "#8B2500"],
    image: "/products/carnelian-ember.jpg",
    stripePriceId: "",
    neckMin: 27,
    neckMax: 33,
    grams: 65,
  ...
  {
    id: "aventurine-glade",
    name: "Aventurine Glade",
    tagline: "Growth and lucky footsteps",
    price: 89,
    crystal: "Green Aventurine",
    chakra: "Heart",
    petBenefit: "Known as the lucky stone — for the one who always finds their way home",
    humanBenefit: "Attracts opportunity, abundance & new growth",
    colors: ["#5B8C5A", "#8FBF6A", "#C5D5C0", "#3D6B3C"],
    image: "/products/aventurine-glade.jpg",
    stripePriceId: "",
    neckMin: 25,
    neckMax: 32,
    grams: 62,
